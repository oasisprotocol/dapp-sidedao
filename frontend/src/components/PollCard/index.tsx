...
const Tank: FC = () => {
  return (
    <div className={classes.tankContainer}>
      <svg className={classes.tank} width="17" height="19" viewBox="0 0 17 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
...
export const PollCard: FC<{
  ...
  const gasLess = true // TODO: how do I find this out from the data?
