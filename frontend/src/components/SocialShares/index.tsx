...
// TODO: actually make this work
const AsLink: FC<{classname?: string}> = ({classname}) => (
  <div className={StringUtils.clsx(classes.socialIcon, classname)}>
...
// TODO: actually make this work
const AsEmbed: FC<{classname?: string}> = ({classname}) => (
  <div className={StringUtils.clsx(classes.socialIcon, classname)}>
    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_2269_194)">
        ...
        <path fillRule="evenodd" clipRule="evenodd"
              d="M15.0366 4.7726L10.8955 20.2274L8.96362 19.7098L13.1047 4.25496L15.0366 4.7726Z" fill="#010038" />
      </g>
      <defs>
...
export const SocialShares: FC<{label: string, className?: string}> = ({label, className}) => (
  <>
    <h4>{label}</h4>
    <div className={classes.socialIcons}>
      <Twitter classname={className}/>
      <LinkedIn classname={className}/>
      <AsLink classname={className}/>
      <AsEmbed classname={className}/>
    </div>
  </>
)
