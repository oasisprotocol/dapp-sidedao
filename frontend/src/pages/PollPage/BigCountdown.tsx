...
export const BigCountdown: FC<{
  ...
  if (hasHours) wantedCells.push({number: hours, unit: StringUtils.maybePluralUnits(hours, "hour", "hours")})
  if (hasMinutes) wantedCells.push({number: minutes, unit: StringUtils.maybePluralUnits(minutes, "minute", "minutes")})
